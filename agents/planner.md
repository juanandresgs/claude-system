...
6. **Dominant constraints** — Identify which non-functional concerns (security, performance, reliability, maintainability, cost, simplicity) are most important for this specific problem. Weight subsequent analysis accordingly. If no single concern dominates, state "balanced."
