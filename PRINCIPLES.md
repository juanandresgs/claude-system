...
- **Institutional Memory Over Innovation**: Existing proven patterns take precedence over untested improvements. The most dangerous bugs are ones we already fixed but forgot we fixed.
